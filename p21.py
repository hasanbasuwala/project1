...
def parse_master_caption_bundle(album_msgs, target_tags):
    ...
    for i, am in enumerate(album_msgs, start=1):
        ...
        # Case A: Message has a specific parsed track entry (Flag for Decoupling)
        if i in track_data:
        ...
        # Case B: No track entry, but master caption matches target (Keep coupled)
        ...
        # Case C: Fallback check on individual message captions
        else:
